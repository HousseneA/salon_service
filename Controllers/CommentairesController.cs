...
namespace Salon_service.Controllers
{
    ...
    public class CommentairesController : ControllerBase
    {
        ...
        public CommentairesController(tableContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != commentaire.IdCommaitaire)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Commentaire>> PostCommentaire(Commentaire commentaire)
        {
            ...
            return CreatedAtAction("GetCommentaire", new { id = commentaire.IdCommaitaire }, commentaire);
        }
        ...
        {
            return _context.Commentaires.Any(e => e.IdCommaitaire == id);
        }
    }
}
